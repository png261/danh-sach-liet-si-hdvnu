...
export async function GET(request: Request) {
  try {
    ...
    const cemeterySlug = searchParams.get("cemetery");
    ...
    // Dynamically configure the subtitle depending on the cemetery slug
    let subtitleText = "CÁC NGHĨA TRANG LIỆT SĨ XÃ TỨ KỲ";
    if (cemeterySlug) {
      const clean = cemeterySlug.toLowerCase();
      if (clean === "tu-ky" || clean === "tu_ky") {
        subtitleText = "NGHĨA TRANG LIỆT SĨ XÃ TỨ KỲ";
      } else if (clean === "minh-duc" || clean === "minh_duc") {
        subtitleText = "NGHĨA TRANG LIỆT SĨ MINH ĐỨC";
      } else if (clean === "quang-khai" || clean === "quang_khai") {
        subtitleText = "NGHĨA TRANG LIỆT SĨ QUANG KHẢI";
      } else if (clean === "quang-phuc" || clean === "quang_phuc") {
        subtitleText = "NGHĨA TRANG LIỆT SĨ QUANG PHỤC";
      }
    }
